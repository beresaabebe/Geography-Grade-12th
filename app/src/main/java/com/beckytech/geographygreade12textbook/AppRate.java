...
public class AppRate {
    private final static String APP_TITLE = "Geography Textbook Grade 12th";// App Name
    private static final String APP_PNAME = "com.beckytech.geographygreade12textbook";// Package Name
